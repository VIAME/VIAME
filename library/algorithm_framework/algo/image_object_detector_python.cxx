...
void image_object_detector(py::module& m)
{
  ...
  py::module::import("kwiver.vital.types");
    ...
    py::class_<viame::algo::image_object_detector,
               std::shared_ptr<viame::algo::image_object_detector>,
               viame::algorithm,
               image_object_detector_trampoline<> > instance(m,  "ImageObjectDetector");
    
    instance
    .def(py::init<>())
    .def_static("interface_name", &viame::algo::image_object_detector::interface_name)
    .def("detect", &viame::algo::image_object_detector::detect, py::doc(R"( Find all objects on the provided image
 ...
 \returns vector of image objects found)"), py::arg("image_data"))
    .def("batch_detect", &viame::algo::image_object_detector::batch_detect, py::doc(R"( Detect objects in a batch of images
 ...
 \returns Vector of detection sets, one per input image)"), py::arg("images"))
    ;
  register_algorithm< viame::algo::image_object_detector > (instance);
}
