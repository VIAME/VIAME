...
def explicit_output_shape_for(model, inputs):
    ...
    """
    from viame.object_detectors.netharn.netharn.analytic.output_shape_for import OutputShape, HiddenShapes
    import torch
    import ubelt as ub
    ...
    class CustomForwardHook(ub.NiceRepr):
        ...
        def __call__(hook, module, inputs, outputs):
            ...
            if isinstance(outputs, torch.Tensor):
                ...
                print(type(outputs))
                from viame.object_detectors.netharn.netharn.data.data_containers import nestshape
