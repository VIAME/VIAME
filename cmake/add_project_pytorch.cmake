...
list( APPEND PYTORCH_ENV_VARS "TMPDIR=${LIBRARY_PIP_TMP_DIR}" )
...
foreach( LIB ${PYTORCH_LIBS_TO_BUILD} )
  ...
  set( LIBRARY_PYTHON_BUILD
    ${CMAKE_COMMAND} -E env "${PYTORCH_ENV_VARS}" ${LIBRARY_PIP_BUILD_CMD} )
  set( LIBRARY_PYTHON_INSTALL
    ${CMAKE_COMMAND} -E env "${PYTORCH_ENV_VARS}" ${LIBRARY_PIP_INSTALL_CMD} )
