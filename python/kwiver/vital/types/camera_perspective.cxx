...
PYBIND11_MODULE( camera_perspective, m )
{
  ...
  py::class_< kv::camera_perspective,
    ...
    .def(
      "__str__", []( const kv::camera_perspective& self ){
        std::stringstream s;
        s << self;
        return s.str();
      } )
  ...
  py::class_< kv::simple_camera_perspective,
    ...
    .def(
      "look_at",          &kv::simple_camera_perspective::look_at,
      py::arg( "stare_point" ),
      py::arg( "up_direction" ) = kv::vector_3d::UnitZ() )
