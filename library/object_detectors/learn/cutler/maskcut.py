...
from viame.object_detectors.learn.tokencut.unsupervised_saliency_detection import utils, metric
from viame.object_detectors.learn.tokencut.unsupervised_saliency_detection.object_discovery import detect_box
...
if __name__ == "__main__":
    ...
    parser.add_argument('--actual-img-path', type=str, default="", help='path to the training images')
    ...
    parser.add_argument('--img-limit', type=int, default=1000, help='number of images to use')
    ...
    parser.add_argument('--local_rank', type=str, help='rank, ignore')
    ...
    for img_folder in img_folders[start_idx:end_idx]:
        ...
        shuffle(img_list)
        img_list = img_list[:args.img_limit]
            ...
            for idx, bipartition in enumerate(bipartitions):
                ...
                if img_name not in image_names:
                    image_info = create_image_info(
                        image_id, f"{img_name}", (height, width, 3))
    ...
    json_name = '{}/{}_maskcut_annotations.json'.format(args.out_dir, args.stage, args.fixed_size, args.tau, args.N, start_idx, end_idx)
