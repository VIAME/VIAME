...
def _load_deps():
    ...
    import torch
    from viame.object_trackers.pytorch.srnn.track import track_state, track, track_set
    from viame.object_trackers.pytorch.srnn.models import Siamese, get_config
    from viame.object_trackers.pytorch.srnn.srnn_matching import SRNNMatching, RnnType
    from viame.object_trackers.pytorch.srnn.siamese_feature_extractor import SiameseFeatureExtractor
    from viame.object_trackers.pytorch.srnn.iou_tracker import IOUTracker
    from viame.object_trackers.pytorch.srnn.gt_bbox import GTBBox, GTFileType
    g_config = get_config()
    init_cudnn()
