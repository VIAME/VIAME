...
#ifndef VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_DIVE_H
#define VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_DIVE_H
...
struct VIAME_FILE_IO_EXPORT dive_feature
{
  int frame = 0;
...
struct VIAME_FILE_IO_EXPORT dive_track
{
  int id = 0;
  int begin = 0;
  int end = 0;
...
struct VIAME_FILE_IO_EXPORT dive_annotation_file
{
...
#endif // VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_DIVE_H
