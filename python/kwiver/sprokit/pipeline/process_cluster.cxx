...
{
  class_< sprokit::process_cluster, wrap_process_cluster,
    sprokit::process_cluster_t, sprokit::process >(
    m, "PythonProcessCluster",
    ...
    .def(
      "map_config",
      static_cast< void ( sprokit::process_cluster::* )(
        kwiver::vital::config_block_key_t const&,
        sprokit::process::name_t const&,
        kwiver::vital::config_block_key_t const& ) >( &wrap_process_cluster::
                                                      map_config ),
    ...
    .def(
      "add_process",
      static_cast< void ( sprokit::process_cluster::* )(
        sprokit::process::name_t const&, sprokit::process::type_t const&,
        kwiver::vital::config_block_sptr const& ) >( &wrap_process_cluster::
                                                     add_process ),
      arg( "name" ), arg( "type" ),
    ...
    .def(
      "map_input",
      static_cast< void ( sprokit::process_cluster::* )(
        sprokit::process::port_t const&, sprokit::process::name_t const&,
        sprokit::process::port_t const& ) >( &wrap_process_cluster::map_input ),
    ...
    .def(
      ...
      static_cast< void ( sprokit::process_cluster::* )(
        sprokit::process::port_t const&, sprokit::process::name_t const&,
        sprokit::process::port_t const& ) >( &wrap_process_cluster::map_output ),
      arg( "port" ), arg( "name" ), arg( "mapped_port" ),
      "Map an output port to a port on the cluster." )
    .def(
      "connect",
      static_cast< void ( sprokit::process_cluster::* )(
        sprokit::process::name_t const&, sprokit::process::port_t const&,
        sprokit::process::name_t const&,
        sprokit::process::port_t const& ) >( &wrap_process_cluster::connect ),
      arg( "upstream_name" ), arg( "upstream_port" ), arg( "downstream_name" ),
      arg( "downstream_port" ),
      "Connect two ports within the cluster." )
    .def(
      "_properties",
      static_cast< sprokit::process::properties_t ( sprokit::process_cluster::* )()
                   const >( &wrap_process_cluster::_properties ),
    ...
    .def(
      "declare_input_port",
      [](wrap_process_cluster& self, sprokit::process::port_t const& port,
         sprokit::process::port_info_t const& info){
        self.declare_input_port( port, info );
      },
    ...
    .def(
      ...
      []( wrap_process_cluster& self, sprokit::process::port_t const& port,
          ...
          sprokit::process::port_frequency_t const& frequency_ =
            sprokit::process::port_frequency_t( 1 ) ){
    ...
    .def(
      ...
      [](wrap_process_cluster& self, sprokit::process::port_t const& port,
         sprokit::process::port_info_t const& info){
        self.declare_output_port( port, info );
      },
    ...
    .def(
      ...
      [](wrap_process_cluster& self,
         ...
         bool tunable_ = false){
        self.declare_configuration_key( key, def_, description_, tunable_ );
      },
      "Declare a configuration key for the process." )
    .def(
      "processes", &sprokit::process_cluster::processes,
      "Processes in the cluster." )
    .def(
      "input_mappings", &sprokit::process_cluster::input_mappings,
      "Input mappings for the cluster." )
    .def(
      "output_mappings", &sprokit::process_cluster::output_mappings,
      "Output mappings for the cluster." )
    .def(
      "internal_connections", &sprokit::process_cluster::internal_connections,
  ...
  m.def(
    "cluster_from_process", &cluster_from_process,
    ( arg( "process" ) ),
