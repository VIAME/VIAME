...
static ::sprokit::datum::error_t datum_get_error(
  ::sprokit::datum const& self );
...
PYBIND11_MODULE( datum, m )
{
  ...
  m.def(
    "new_bounding_box", &new_datum< kwiver::vital::bounding_box_d >,
    ( arg( "dat" ) ),
    "Creates a new bounding box" );
  m.def(
    "new_timestamp", &new_datum< kwiver::vital::timestamp >,
    ( arg( "dat" ) ),
    "Creates a new timestamp" );
  m.def(
    "new_corner_points", &new_datum< kwiver::vital::geo_polygon >,
    ( arg( "dat" ) ),
  ...
  m.def(
    "new_f2f_homography", &new_datum< kwiver::vital::f2f_homography >,
    ( arg( "dat" ) ),
  ...
  // Methods on datum
  class_< sprokit::datum, std::shared_ptr< sprokit::datum > >(
    m, "Datum",
    ...
    .def(
      "get_bounding_box", &datum_get_object< kwiver::vital::bounding_box_d >,
      "Convert the data to a bounding box" )
    .def(
      "get_timestamp", &datum_get_object< kwiver::vital::timestamp >,
      "Convert the data to a timestamp" )
    .def(
      "get_corner_points", &datum_get_object< kwiver::vital::geo_polygon >,
      "Convert the data to a set of corner points" )
    .def(
      "get_string", &datum_get_object< std::string >,
      "Convert the data to a string" )
    .def(
      "get_f2f_homography", &datum_get_object< kwiver::vital::f2f_homography >,
...
datum_get_datum_ptr( ::sprokit::datum& self )
{
  return PyCapsule_New(
    const_cast< ::sprokit::datum* >( std::make_shared< ::sprokit::datum >(
      self ).get() ), "sprokit::datum", NULL );
}
...
datum_from_capsule( PyObject* cap )
{
  ...
  {
    ::sprokit::datum* dptr =
      static_cast< ::sprokit::datum* >( PyCapsule_GetPointer(
        cap,
        "sprokit::datum" ) );
