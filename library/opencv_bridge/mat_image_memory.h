...
/// An image memory class that shares memory with OpenCV using reference
/// counting
class VIAME_OPENCV_BRIDGE_EXPORT mat_image_memory
...
public:
  ...
  int*
  get_ref_counter() const { return this->mat_refcount_; }
#else
  cv::UMatData*
  get_umatdata() const { return this->u_; }
#endif
