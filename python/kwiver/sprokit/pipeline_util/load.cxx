...
static object cluster_subblock_config(
  ::sprokit::cluster_subblock_t const& subblock );
static void cluster_subblock_config_set(
  ::sprokit::cluster_subblock_t& subblock,
  ::sprokit::cluster_config_t const& config );
static object cluster_subblock_input(
  ::sprokit::cluster_subblock_t const& subblock );
static void cluster_subblock_input_set(
  ::sprokit::cluster_subblock_t& subblock,
  ::sprokit::cluster_input_t const& input );
static object cluster_subblock_output(
  ::sprokit::cluster_subblock_t const& subblock );
static void cluster_subblock_output_set(
  ::sprokit::cluster_subblock_t& subblock,
  ::sprokit::cluster_output_t const& output );
static object cluster_block_config( ::sprokit::cluster_block const& block );
static void cluster_block_config_set(
  ::sprokit::cluster_block& block,
  ::sprokit::config_pipe_block const& config );
static object cluster_block_process( ::sprokit::cluster_block const& block );
static void cluster_block_process_set(
  ::sprokit::cluster_block& block,
  ::sprokit::process_pipe_block const& process );
static object cluster_block_connect( ::sprokit::cluster_block const& block );
static void cluster_block_connect_set(
  ::sprokit::cluster_block& block,
  ::sprokit::connect_pipe_block const& connect );
static object cluster_block_cluster( ::sprokit::cluster_block const& block );
static void cluster_block_cluster_set(
  ::sprokit::cluster_block& block,
  ::sprokit::cluster_pipe_block const& cluster );
...
static std::vector< wrap_port_addr > get_targets(
  ::sprokit::cluster_input_t const& self );
static void set_targets(
  ::sprokit::cluster_input_t& self,
  std::vector< wrap_port_addr > const& wrap_targets );
...
PYBIND11_MODULE( load, m )
{
  ...
  ;
  class_< sprokit::cluster_config_t >(
    m, "ClusterConfig",
  ...
  ;
  class_< sprokit::cluster_input_t >(
    m, "ClusterInput",
  ...
  ;
  class_< sprokit::cluster_output_t >(
    m, "ClusterOutput",
  ...
  ;
  class_< sprokit::cluster_subblock_t >(
    m, "ClusterSubblock",
    "A subblock within a cluster." )
    .def( init<>() )
    .def_property(
      "config", &cluster_subblock_config,
      &cluster_subblock_config_set )
    .def_property(
      "input", &cluster_subblock_input,
      &cluster_subblock_input_set )
    .def_property(
      "output", &cluster_subblock_output,
      &cluster_subblock_output_set )
  ;
  class_< sprokit::cluster_subblocks_t >(
    m, "ClusterSubblocks",
    "A collection of cluster subblocks." )
    .def( init<>() )
  /// \todo Need operator == on cluster_subblock_t for pybind11::bind_vector
  ;
  class_< sprokit::cluster_pipe_block >(
    m, "ClusterBlock",
  ...
  ;
  class_< sprokit::cluster_block >(
    m, "ClusterDefineBlock",
    "A block in a pipeline declaration file." )
    .def( init<>() )
    .def_property( "config", &cluster_block_config, &cluster_block_config_set )
    .def_property(
      "process", &cluster_block_process,
      &cluster_block_process_set )
    .def_property(
      "connect", &cluster_block_connect,
      &cluster_block_connect_set )
    .def_property(
      "cluster", &cluster_block_cluster,
      &cluster_block_cluster_set )
  ;
  class_< sprokit::cluster_blocks >(
    m, "ClusterDefineBlocks",
  ...
  m.def(
    "load_cluster_file", &load_cluster_file,
    call_guard< pybind11::gil_scoped_release >(),
    ( arg( "path" ) ),
    "Load cluster blocks from a file." );
  m.def(
    "load_cluster", &load_cluster, call_guard< pybind11::gil_scoped_release >(),
    ( arg( "stream" ) ),
...
cluster_subblock_config( ::sprokit::cluster_subblock_t const& subblock )
{
  return std::visit(
    cluster_subblock_visitor(
      cluster_subblock_visitor::BLOCK_CONFIG ), subblock );
}
...
cluster_subblock_input( ::sprokit::cluster_subblock_t const& subblock )
{
  return std::visit(
    cluster_subblock_visitor(
      cluster_subblock_visitor::BLOCK_INPUT ), subblock );
}
...
cluster_subblock_output( ::sprokit::cluster_subblock_t const& subblock )
{
  return std::visit(
    cluster_subblock_visitor(
      cluster_subblock_visitor::BLOCK_OUTPUT ), subblock );
}
...
{
  return std::visit(
    pipe_block_visitor( pipe_block_visitor::BLOCK_CLUSTER ),
    block );
}
