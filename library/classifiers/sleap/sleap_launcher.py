...
Training: python -m viame.classifiers.sleap.sleap_launcher request.json
Testing:  python -m viame.classifiers.sleap.sleap_launcher request.json --evaluate model.pt
"""
import argparse
import json
