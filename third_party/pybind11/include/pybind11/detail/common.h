...
// Kwiver compat: disable the GIL-held incref/decref runtime assertion that was
// added in pybind11 2.12. Kwiver's sprokit trampoline classes and some Python
// dec_ref paths in numpy interop violate this on shutdown; before 2.12 those
// calls were silently accepted, and re-enabling the check would require
// invasive changes to kwiver's source.
#if !defined(PYBIND11_NO_ASSERT_GIL_HELD_INCREF_DECREF)
