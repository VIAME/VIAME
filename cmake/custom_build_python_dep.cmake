...
#
# Optional variables:
#   ABI_TAG         - Extra string folded into the hash (the torch version)
...
function( get_source_hash SOURCE_DIR OUT_HASH )
  ...
  # larger repo (e.g. library/object_trackers/mdnet/mdnet inside viame) doesn't
  # report the whole viame repo's HEAD / diff. Without this, any uncommitted
  # change anywhere in viame alters the hash and forces a rebuild.
  execute_process(
...
# Torch extensions only load against the torch they were built with, and the
# source hash alone does not notice a torch upgrade
if( ABI_TAG )
