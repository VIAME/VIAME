...
if( VIAME_ENABLE_PYTORCH AND NOT VIAME_ENABLE_PYTORCH-INTERNAL )
  ...
  if( CUDA_VERSION VERSION_EQUAL "11.3" )
    set( CUDA_VER_STR "+cu113" )
  elseif( CUDA_VERSION VERSION_EQUAL "11.2" )
    set( CUDA_VER_STR "+cu112" )
  ...
  # Special case, no 11.1 or 11.2 bins available
  if( CUDA_VERSION VERSION_GREATER_EQUAL "11.0" AND
      CUDA_VERSION VERSION_LESS "11.3" AND
      PYTORCH_VERSION VERSION_EQUAL "1.11.0" )
    set( CUDA_VER_STR "+cu113" )
  endif()

  if( NOT VIAME_ENABLE_PYTORCH-VIS-INTERNAL )
    if( PYTORCH_VERSION VERSION_EQUAL "1.11.0" )
      set( TORCHVISION_STR "torchvision==0.12.0${CUDA_VER_STR}" )
