...
void track_objects(py::module& m)
{
  ...
  py::module::import("viame.types");
    ...
    py::class_<viame::algo::track_objects,
               std::shared_ptr<viame::algo::track_objects>,
               viame::algorithm,
               track_objects_trampoline<> > instance(m,  "TrackObjects");
    
    instance
    .def(py::init<>())
    .def_static("interface_name", &viame::algo::track_objects::interface_name)
    .def("track", (viame::object_track_set_sptr (viame::algo::track_objects::*)(::viame::timestamp, ::viame::image_container_sptr, ::viame::detected_object_set_sptr) const) &viame::algo::track_objects::track, py::doc(R"( Track objects in a new frame.
 ...
 \returns Updated object track set containing all active tracks)"), py::arg("ts"), py::arg("image"), py::arg("detections"))
    .def("track", (viame::object_track_set_sptr (viame::algo::track_objects::*)(::viame::timestamp, ::viame::image_container_sptr, ::viame::detected_object_set_sptr, ::viame::f2f_homography_sptr) const) &viame::algo::track_objects::track, py::doc(R"( Track objects with homography support.
 ...
 \returns Updated object track set containing all active tracks)"), py::arg("ts"), py::arg("image"), py::arg("detections"), py::arg("src_to_ref"))
    .def("track", (viame::object_track_set_sptr (viame::algo::track_objects::*)(::viame::timestamp, ::viame::image_container_sptr, ::viame::detected_object_set_sptr, ::viame::object_track_set_sptr) const) &viame::algo::track_objects::track, py::doc(R"( Track objects with existing tracks provided.
 ...
 \returns Updated object track set with both existing and new tracks)"), py::arg("ts"), py::arg("image"), py::arg("detections"), py::arg("existing_tracks"))
    .def("initialize", &viame::algo::track_objects::initialize, py::doc(R"( Initialize the tracker for a new sequence.
 ...
 \returns Initial track set (may be empty if no seeds provided))"), py::arg("ts"), py::arg("image"), py::arg("seed_detections"))
    .def("finalize", &viame::algo::track_objects::finalize, py::doc(R"( Finalize tracking and return all tracks.
 ...
 \returns Final object track set with all tracks from the sequence)"))
    .def("reset", &viame::algo::track_objects::reset, py::doc(R"( Reset the tracker state.

 Clears all internal state, active tracks, and cached data.
 After reset, the tracker is ready to begin a new sequence.)"))
    ;
  register_algorithm< viame::algo::track_objects > (instance);
}
