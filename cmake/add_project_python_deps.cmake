...
if( VIAME_FIXUP_BUNDLE )
  ...
  list( APPEND VIAME_PYTHON_BASIC_DEPS "numpy" )
endif()
...
if( Python_VERSION VERSION_LESS "3.9" )
  ...
  list( APPEND VIAME_PYTHON_BASIC_DEPS  "llvmlite==0.42.0" "numba==0.59.0" )
endif()
...
if( VIAME_ENABLE_OPENCV OR VIAME_ENABLE_PYTORCH-NETHARN )
  list( APPEND VIAME_PYTHON_BASIC_DEPS "ubelt<=1.2.3" "pygments" )
  if( Python_VERSION VERSION_GREATER_EQUAL "3.10" )
    list( APPEND VIAME_PYTHON_BASIC_DEPS "bezier==2023.7.28" )
  elseif( Python_VERSION VERSION_GREATER_EQUAL "3.9" )
    list( APPEND VIAME_PYTHON_BASIC_DEPS "bezier==2021.2.12" )
  else()
