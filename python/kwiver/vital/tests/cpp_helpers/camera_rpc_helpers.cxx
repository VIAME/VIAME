...
{
  m.def(
    "call_clone", []( const kv::camera_rpc& self){
      return self.clone();
    } );

  m.def(
    "call_rpc_coeffs", []( const kv::camera_rpc& self ){
      return self.rpc_coeffs();
    } );

  m.def(
    "call_world_scale", []( const kv::camera_rpc& self ){
      return self.world_scale();
    } );

  m.def(
    "call_world_offset", []( const kv::camera_rpc& self ){
      return self.world_offset();
    } );

  m.def(
    "call_image_scale", []( const kv::camera_rpc& self ){
      return self.image_scale();
    } );

  m.def(
    "call_image_offset", []( const kv::camera_rpc& self ){
      return self.image_offset();
    } );

  m.def(
    "call_image_width", []( const kv::camera_rpc& self ){
      return self.image_width();
    } );

  m.def(
    "call_image_height", []( const kv::camera_rpc& self ){
      return self.image_height();
    } );

  m.def(
    "call_project", []( const kv::camera_rpc& self,
                        const kv::vector_3d& pt ){
      return self.project( pt );
    } );

  m.def(
    "call_back_project", []( const kv::camera_rpc& self,
                             kv::vector_2d& pt,
                             double elev ){
