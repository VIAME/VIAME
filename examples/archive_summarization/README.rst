...
- ``-p pipelines/index_generic.pipe`` - Detection/indexing pipeline to use
...
The default uses ``pipelines/index_generic.pipe`` which runs a generic fish
...
- ``index_generic.pipe`` - Default detection and indexing
