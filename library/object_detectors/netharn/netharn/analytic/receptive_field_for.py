...
from viame.object_detectors.netharn.netharn.analytic.output_shape_for import OutputShapeFor
from viame.object_detectors.netharn.netharn.analytic import analytic_for
# try:
...
class _TorchMixin(object):
    ...
    def _kernelized_tranpose(module, input_field=None):
        ...
        Example:
            >>> from .analytic.receptive_field_for import *
            >>> from viame.object_detectors.netharn.netharn.analytic.output_shape_for import *
