...
CLI:
    python -m viame.object_detectors.netharn.netharn_mmdet_to_onnx \
...
def load_netharn_model(deployed_fpath):
    ...
    tree.
    """
    from viame.object_detectors.netharn.netharn.detect_predict import (
        patch_legacy_mm_test_cfg, setup_module_aliases)
    from viame.object_detectors.netharn.netharn.torch_liberator.deployer import DeployedModel
