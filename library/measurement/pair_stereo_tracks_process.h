...
#ifndef VIAME_MEASUREMENT_PAIR_STEREO_TRACKS_PROCESS_H
#define VIAME_MEASUREMENT_PAIR_STEREO_TRACKS_PROCESS_H
...
#endif // VIAME_MEASUREMENT_PAIR_STEREO_TRACKS_PROCESS_H
