...
__vital_algorithm_declarations__ = [
    ...
    ( "train_tracker", "botsort",
      ...
      "viame.object_trackers.pytorch.botsort_trainer:BoTSORTTrainer" ),
    ...
    ( "train_tracker", "motr",
      ...
      "viame.object_trackers.pytorch.motr_trainer:MOTRTrainer" ),
    ( "train_tracker", "srnn",
      "PyTorch SRNN tracker training routine",
      "viame.object_trackers.pytorch.srnn_trainer:SRNNTrainer" ),
]
