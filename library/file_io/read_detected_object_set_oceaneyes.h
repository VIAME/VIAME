...
#ifndef VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_OCEANEYES_H
#define VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_OCEANEYES_H
...
class VIAME_FILE_IO_EXPORT read_detected_object_set_oceaneyes
...
#endif // VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_OCEANEYES_H
