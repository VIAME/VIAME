...
"""The netharn whole-frame classifier and detection refiner.
...
__vital_algorithm_declarations__ = [
    ( "image_object_detector", "netharn_classifier",
      ...
      "viame.classifiers.netharn.netharn_classifier:NetharnClassifier" ),
    ( "refine_detections", "netharn",
      "PyTorch Netharn refiner routine",
      "viame.classifiers.netharn.netharn_refiner:NetharnRefiner" ),
]
