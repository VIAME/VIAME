...
#define VIAME_OCV_WT_PARAMS \
  ...
  PLUGGABLE_VARIABLES( VIAME_OCV_WT_PARAMS )
  PLUGGABLE_CONSTRUCTOR( ocv_windowed_trainer, VIAME_OCV_WT_PARAMS )
  PLUGGABLE_IMPL_BASIC_NAMED(
    ocv_windowed_trainer, "ocv_windowed",
    "Window some other arbitrary detector trainer across the image" )
  PLUGGABLE_STATIC_FROM_CONFIG( ocv_windowed_trainer, VIAME_OCV_WT_PARAMS )
  PLUGGABLE_STATIC_GET_DEFAULT( VIAME_OCV_WT_PARAMS )
  PLUGGABLE_SET_CONFIGURATION( ocv_windowed_trainer, VIAME_OCV_WT_PARAMS )
