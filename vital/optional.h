...
// the call to convert<A>(b) has return type A and converts b to type
// A iff b decltype(b) is implicitly convertible to A
template <class U>
...
template < typename T >
struct hash< kwiver::vital::optional< T > >
{
  typedef typename hash< T >::result_type result_type;
  typedef kwiver::vital::optional< T > argument_type;
