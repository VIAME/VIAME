...
template< class train_tracker_base = viame::algo::train_tracker >
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
  ...
  void
  add_data_from_disk(::viame::category_hierarchy_sptr object_labels, ::std::vector<std::basic_string<char> > train_image_names, ::std::vector<std::shared_ptr<viame::object_track_set> > train_groundtruth, ::std::vector<std::basic_string<char> > test_image_names, ::std::vector<std::shared_ptr<viame::object_track_set> > test_groundtruth) override
  {
    PYBIND11_OVERLOAD(
      void,
      viame::algo::train_tracker,
      add_data_from_disk,
  ...
  void
  add_data_from_memory(::viame::category_hierarchy_sptr object_labels, ::std::vector<std::shared_ptr<viame::image_container> > train_images, ::std::vector<std::shared_ptr<viame::object_track_set> > train_groundtruth, ::std::vector<std::shared_ptr<viame::image_container> > test_images, ::std::vector<std::shared_ptr<viame::object_track_set> > test_groundtruth) override
  {
    PYBIND11_OVERLOAD(
      void,
      viame::algo::train_tracker,
