  ...
  size_t dst_height )
{
  ...
  if( traits.type == kv::image_pixel_traits::UNSIGNED )
  {
    ...
    {
      // Eight bit goes through `image_kernels`, which reproduces `cv::resize`'s
      ...
      case 1: return kv::image( image_kernels::resize(
  ...
  double scale )
{
  ...
  {
    return kv::image( image_kernels::resize_by_scale(
