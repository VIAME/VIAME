...
#ifndef VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_CVAT_H
#define VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_CVAT_H
...
class VIAME_FILE_IO_EXPORT read_detected_object_set_cvat
...
#endif // VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_CVAT_H
