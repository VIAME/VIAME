...
void match_features(py::module& m)
{
  ...
  py::module::import("kwiver.vital.types");
    ...
    instance
    .def(py::init<>())
    .def_static("interface_name", &kwiver::vital::algo::match_features::interface_name)
    .def("match", &kwiver::vital::algo::match_features::match, py::doc(R"( Match one set of features and corresponding descriptors to another
 ...
 \returns a set of matching indices from \a feat1 to \a feat2)"), py::arg("feat1"), py::arg("desc1"), py::arg("feat2"), py::arg("desc2"))
    ;
  register_algorithm< kwiver::vital::algo::match_features > (instance);
}
