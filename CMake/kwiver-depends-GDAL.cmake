...
if( KWIVER_ENABLE_GDAL )
  ...
  if( GDAL_FOUND )
    ...
    file( APPEND ${CMAKE_BINARY_DIR}/test_gdal_version.cxx "#if ( GDAL_COMPUTE_VERSION( 1, 11, 5  ) != GDAL_VERSION_NUM )\n")
    ...
    if( GDAL_VERSION_MATCH )
      ...
      message( FATAL_ERROR "GDAL found, but not needed version. Need version: 1.11.5" )
      message(${OUTPUT})
