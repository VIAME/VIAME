...
#ifndef KWIVER_ARROWS_OCV_REFINE_DETECTIONS_GRABCUT_H_
#define KWIVER_ARROWS_OCV_REFINE_DETECTIONS_GRABCUT_H_
...
class KWIVER_ALGO_OCV_EXPORT refine_detections_grabcut
: public vital::algorithm_impl<refine_detections_grabcut,
