...
| `object_detectors/` | `arrows/ocv/{hough_circle_detector,detect_heat_map,detect_motion_3frame_differencing}` (until P7), `sprokit/processes/core/{image_object_detector,detect_motion}_process` |
| `object_trackers/` | `arrows/core/{initialize_object_tracks_threshold,associate_detections_to_tracks_threshold,compute_association_matrix_from_features,track_set_impl helpers}`, `sprokit/processes/core/{track_objects,initialize_object_tracks,associate_detections_to_tracks,compute_association_matrix,merge_track_sets,convert_tracks_to_detections,unwrap_detections}_process` |
...
| `descriptors/` | `sprokit/processes/core/{compute_track_descriptors,perform_query,handle_descriptor_request}_process` |
| `measurement/` | `arrows/mvg/triangulate` + camera helpers, `arrows/ocv/camera_intrinsics` (until P7), `sprokit/processes/core/compute_stereo_depth_map_process` |
