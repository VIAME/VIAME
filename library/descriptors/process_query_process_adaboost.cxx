...
create_config_trait( lsh_hashes_postfix, std::string, "_hashes.npy",
  "Postfix of the per-video LSH hash code files in descriptor_index_dir; "
  "used instead of lsh_hash_codes_file / lsh_hash_uids_file when present." );
...
public:
  priv()
    ...
    , m_logger( viame::get_logger( "viame.opencv.process_query_adaboost" ) ) {}
