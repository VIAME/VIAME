...
register_factories( kv::plugin_loader& vpm )
{
  ...
  fact->add_attribute( kvpf::PLUGIN_NAME, enhance_images::plugin_name() )
    .add_attribute( kvpf::PLUGIN_MODULE_NAME, module_name );

  fact = vpm.add_factory< kv::algo::image_filter, perform_white_balancing >(
    perform_white_balancing::plugin_name() );
  fact->add_attribute( kvpf::PLUGIN_NAME, perform_white_balancing::plugin_name() )
    .add_attribute( kvpf::PLUGIN_MODULE_NAME, module_name );
