...
::rectified_projection( bool is_right_camera ) const
{
  if( !m_rectification_computed )
  {
    return kv::matrix_3x4d::Zero();
  }
  return is_right_camera ? m_P2 : m_P1;
}
...
public:
  ...
  {
    kv::matrix_3x4d const P1 = m_utilities.rectified_projection( false );
    kv::matrix_3x4d const P2 = m_utilities.rectified_projection( true );
    py::dict out;
    out[ "fx" ] = P1( 0, 0 );
    out[ "fy" ] = P1( 1, 1 );
    out[ "cx_left" ] = P1( 0, 2 );
