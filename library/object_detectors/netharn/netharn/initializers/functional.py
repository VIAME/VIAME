...
def maximum_common_ordered_subpaths(paths1, paths2, sep='.', mode='embedding'):
    ...
    # viame.object_detectors.netharn.netharn and is not importable by that name). Guard it; the
    ...
    try:
        ...
        pass
    from viame.object_detectors.netharn.netharn.torch_liberator.initializer import maximum_common_ordered_subpaths
