        ...
        match model_path.suffix.lower():
            ...
            case ".ckpt" | ".pth":  # pytorch backend
                ...
                if cfg.get('name') == "viame-mit-yolo-detector":
                    ...
                    from viame.object_detectors.mit_yolo.yolomit_to_onnx import yolomit_to_onnx
            ...
            case ".zip":  # netharn / bioharn mmdet backend
                ...
                from viame.object_detectors.netharn.netharn_mmdet_to_onnx import netharn_mmdet_to_onnx
