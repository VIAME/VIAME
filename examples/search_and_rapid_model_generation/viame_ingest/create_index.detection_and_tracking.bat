...
python.exe "%VIAME_INSTALL%\configs\process_video.py" --init -l input_list.txt -p pipelines\index_default.trk.pipe -o database --build-index -install "%VIAME_INSTALL%"
