...
from viame.object_detectors.kwcoco_train_detector import KWCocoTrainDetector
from viame.object_detectors.kwcoco_train_detector import KWCocoTrainDetectorConfig
