...
**Windows Binaries:** <br>
[VIAME v0.9.8.1 Windows 7/8/10, 64-Bit, GPU Enabled, CUDA 8.0, Python 3.6, Mirror1](Currently Uploading) <br>
[VIAME v0.9.8.1 Windows 7/8/10, 64-Bit, GPU Enabled, CUDA 8.0, Python 3.6, Mirror2](https://drive.google.com/open?id=1uqkrbmXSBYsgFtgSa12Ar3lZjGbaGad-) <br>
[VIAME v0.9.8.1 Windows 7/8/10, 64-Bit, CPU Only, Python 3.6, Mirror1](Currently Uploading) <br>
[VIAME v0.9.8.1 Windows 7/8/10, 64-Bit, CPU Only, Python 3.6, Mirror2](Currently Uploading)
