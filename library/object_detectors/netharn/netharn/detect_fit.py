...
class DetectFitConfig(scfg.Config):
    ...
    def __post_init__(self):
        ...
        if self['datasets'] == 'special:voc':
            from viame.object_detectors.netharn.netharn.data.grab_voc import ensure_voc_coco
...
class DetectHarn(nh.FitHarn):
    ...
    def on_complete(harn):
        ...
        """
        from viame.object_detectors.netharn.netharn import detect_eval
        # TODO: FIX
...
def setup_harn(cmdline=True, **kw):
    ...
    if config['normalize_inputs'] == 'imagenet':
        ...
        if input_stats is None:
            ...
            from viame.object_detectors.netharn.netharn.data.data_containers import container_collate
...
def fit(**kw):
    ...
    if ub.argflag('--lrtest'):
        ...
        from viame.object_detectors.netharn.netharn.prefit.lr_tests import lr_range_test
