...
#ifndef VIAME_OBJECT_DETECTORS_DARKNET_DETECTOR_H
#define VIAME_OBJECT_DETECTORS_DARKNET_DETECTOR_H

#include "viame_object_detectors_darknet_export.h"
...
#endif /* VIAME_OBJECT_DETECTORS_DARKNET_DETECTOR_H */
