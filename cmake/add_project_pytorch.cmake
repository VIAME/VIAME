...
if( WIN32 )
  ...
  set( EXTRA_INCLUDE_DIRS
    "${VIAME_BUILD_INSTALL_PREFIX}/include;$ENV{INCLUDE}" )
  set( EXTRA_LIBRARY_DIRS
    "${VIAME_BUILD_INSTALL_PREFIX}/lib;$ENV{LIB}" )
  ...
  list( APPEND EXTRA_ENV "INCLUDE=${EXTRA_INCLUDE_DIRS}" )
  list( APPEND EXTRA_ENV "LIB=${EXTRA_LIBRARY_DIRS}" )
else()
  set( CUSTOM_PYTHONPATH
    ${PYTHON_BASEPATH}:${PYTHON_BASEPATH}/site-packages:${PYTHON_BASEPATH}/dist-packages )
  if( VIAME_ENABLE_CUDA )
  ...
  list( APPEND EXTRA_ENV "CXX=${CMAKE_CXX_COMPILER}" )
endif()
