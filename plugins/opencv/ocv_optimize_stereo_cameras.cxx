...
ocv_optimize_stereo_cameras::get_configuration() const
{
...
void
ocv_optimize_stereo_cameras::set_configuration( kv::config_block_sptr config_in )
{
...
bool
ocv_optimize_stereo_cameras::check_configuration( kv::config_block_sptr config ) const
{
  return true;
}
