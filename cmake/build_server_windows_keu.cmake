...
if(DEFINED ENV{VIAME_SOURCE_DIR})
    file(TO_CMAKE_PATH "$ENV{VIAME_SOURCE_DIR}" CTEST_SOURCE_DIRECTORY)
else()
    set(CTEST_SOURCE_DIRECTORY "C:/VIAME-Builds/GPU")
endif()

if(DEFINED ENV{VIAME_BUILD_DIR})
    file(TO_CMAKE_PATH "$ENV{VIAME_BUILD_DIR}" CTEST_BINARY_DIRECTORY)
else()
...
add_option("VIAME_ENABLE_SEAGIS" "OFF")
