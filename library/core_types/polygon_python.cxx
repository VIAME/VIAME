...
PYBIND11_MODULE( polygon, m )
{
  py::class_< kv::polygon, std::shared_ptr< kv::polygon > >( m, "Polygon" )
    ...
    .def(
      "push_back",
      ( void ( kv::polygon::* )( double, double ) )( &kv::polygon::push_back ) )
    .def(
      "push_back",
      ( void ( kv::polygon::* )( const kv::polygon::point_t& ) )(
        &kv::polygon::push_back ) )
    .def( "num_vertices", &kv::polygon::num_vertices )
    .def( "get_vertices", &kv::polygon::get_vertices )
    .def(
      "contains",
      ( bool ( kv::polygon::* )( double, double ) )( &kv::polygon::contains ) )
    .def(
      "contains",
      ( bool ( kv::polygon::* )( const kv::polygon::point_t& ) )(
        &kv::polygon::contains ) )
