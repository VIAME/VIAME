...
// ----------------------------------------------------------------------------
std::ostream&
operator<<( std::ostream& str, const point_2i& p ) { return out( str, p ); }
std::ostream&
operator<<( std::ostream& str, const point_2d& p ) { return out( str, p ); }
std::ostream&
operator<<( std::ostream& str, const point_2f& p ) { return out( str, p ); }
std::ostream&
operator<<( std::ostream& str, const point_3d& p ) { return out( str, p ); }
std::ostream&
operator<<( std::ostream& str, const point_3f& p ) { return out( str, p ); }
std::ostream&
operator<<( std::ostream& str, const point_4d& p ) { return out( str, p ); }
std::ostream&
