...
from viame.object_detectors.netharn.netharn import detect_predict
from viame.object_detectors.netharn.netharn.data import data_containers  # NOQA
from viame.object_detectors.netharn.netharn.data import channel_spec  # NOQA
...
class DetectEvaluator(object):
    ...
    def demo_config(cls):
        ...
        """
        from viame.object_detectors.netharn.netharn import detect_fit
        aux = False
