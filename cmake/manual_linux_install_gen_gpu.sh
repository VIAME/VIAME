...
docker pull nvidia/cuda:13.3.0-cudnn-devel-rockylinux8
chmod +x cmake/build_server_rocky.sh
docker run -td --runtime=nvidia --name viame_installer_zip nvidia/cuda:13.3.0-cudnn-devel-rockylinux8 bash
cd ../
