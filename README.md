...
[VIAME v0.9.13 Windows 7/8/10, 64-Bit, GPU Enabled, CUDA 8.0, Python 3.6, Mirror1](https://data.kitware.com/api/v1/item/5cffdab28d777f072b23bab7/download) <br>
[VIAME v0.9.13 Windows 7/8/10, 64-Bit, GPU Enabled, CUDA 8.0, Python 3.6, Mirror2](https://drive.google.com/open?id=1VXDKbcNKjEu1S-206mQUjDVcDKyUJTBE) <br>
