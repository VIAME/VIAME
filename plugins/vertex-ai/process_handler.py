...
class ProcessHandler:
  ...
  def _writer_settings( output_dir, basename, output_type, output_ext,
    ...
    # no "# metadata, fps: ..." header. The detection writer needs no flag to
    # emit timestamps for video, since the pipelines fall back to the frame
    # time whenever there is no image file name, but the track writer still
    # has to be told.
