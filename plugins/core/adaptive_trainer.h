...
#ifndef VIAME_CORE_ADAPTIVE_TRAINER_H
#define VIAME_CORE_ADAPTIVE_TRAINER_H
...
// -----------------------------------------------------------------------------
/**
 * @brief Adaptive trainer that analyzes data and runs appropriate training pipelines
 *
 ...
 */
class VIAME_CORE_EXPORT adaptive_trainer
  : public kwiver::vital::algorithm_impl< adaptive_trainer,
...
#endif /* VIAME_CORE_ADAPTIVE_TRAINER_H */
