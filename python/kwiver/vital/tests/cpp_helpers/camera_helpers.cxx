...
{
  m.def(
    "call_clone", []( const kv::camera& cam ){
      return cam.clone();
    } );

  m.def(
    "call_project", []( const kv::camera& cam, const kv::vector_3d& pt ){
      return cam.project( pt );
    } );

  m.def(
    "call_image_width", []( const kv::camera& cam ){
      return cam.image_width();
    } );

  m.def(
    "call_image_height", []( const kv::camera& cam ){
