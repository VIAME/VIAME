...
def _get_vc_env(vc_arch: str) -> dict[str, str]:
    ...
    # Fallback for setuptools >= 75 where _get_vc_env was removed.
    # Return current environment (lowercased keys) which works when
    # the build system already provides MSVC variables (INCLUDE, LIB, etc).
