...
public:
  ...
  bool get_camera_position_prior_local(
    frame_id_t fid,
  ...
  /// \param[out] R_loc the rotation in the local frame according to the
  /// metadata
  /// \return return true if orientation prior is recovered from metadata, false
  /// otherwise
  bool get_camera_orientation_prior_local(
    frame_id_t fid,
  ...
  /// \return true if the image width is recovered from the constraints, false
  /// otherwise
  ...
  /// \return true if the image height is recovered from the constraints, false
  /// otherwise
  ...
  /// \return true if the focal length prior is found in the metadata, false
  /// otherwise
