...
# Run full build and setup libraries - CMake will skip already-built targets from Stage 1
run_build_and_setup_libraries "$CUDA_DIRECTORY" > build_log_stage2.txt 2>&1

# Verify build success and create tarball
if verify_build_success build_log_stage2.txt; then
