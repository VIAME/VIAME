...
PYBIND11_MODULE( category_hierarchy, m )
{
  py::class_< kv::category_hierarchy,
    ...
    .def(
      py::init< const label_vec_t&, const label_vec_t&,
        const label_id_vec_t& >(),
      py::arg( "class_names" ), py::arg( "parent_names" ) = label_vec_t(),
      py::arg( "ids" ) = label_id_vec_t() )
    .def(
      "add_class", &kv::category_hierarchy::add_class,
    ...
    .def( "get_class_synonyms", &kv::category_hierarchy::get_class_synonyms )
