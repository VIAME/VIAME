...
#include <viame/core_types/geo_MGRS.h>
...
PYBIND11_MODULE( geo_MGRS, m )
{
  py::class_< kv::geo_MGRS, std::shared_ptr< kv::geo_MGRS > >( m, "GeoMGRS" )
    ...
    .def(
      "__eq__", []( kv::geo_MGRS const& self, kv::geo_MGRS const& other ){
        return self == other;
      } )
    .def(
      "__ne__", []( kv::geo_MGRS const& self, kv::geo_MGRS const& other ){
        return self != other;
      } )
    .def(
      "__str__", []( kv::geo_MGRS const& self ){
