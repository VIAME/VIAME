...
set( FLETCH_DEP_FLAGS
  ...
  -Dpybind11_SELECT_VERSION:STRING=2.13.6
)
...
if( VIAME_ENABLE_OPENCV OR VIAME_ENABLE_SEAL OR VIAME_ENABLE_VIVIA )
  set( FLETCH_DEP_FLAGS
    ${FLETCH_DEP_FLAGS}
...
ExternalProject_Add(fletch
  ...
  INSTALL_COMMAND ${CMAKE_COMMAND}
    ...
    -DVIAME_BUILD_FLETCH_DIR:PATH=${VIAME_BUILD_FLETCH_DIR}
...
if( FALSE )  # VXL is no longer built
  set( VIAME_ARGS_VXL
    ${VIAME_ARGS_VXL}
