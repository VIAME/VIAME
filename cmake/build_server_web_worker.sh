...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/cuda/lib64:/viame/build/install/lib:/viame/build/install/lib/python3.6
...
-DVIAME_ENABLE_PYTORCH-DISABLE-NINJA:BOOL=ON \
