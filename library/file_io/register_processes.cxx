...
register_factories( viame::registry& vpm )
{
  static auto const module_name =
    viame::plugin_manager::module_t( "viame_processes_file_io" );
...
#define VIAME_REGISTER_PROCESS( process_type, plugin, blurb )             \
  ...
  VIAME_REGISTER_PROCESS(
    viame::detected_object_input_process, "detected_object_input",
    "Reads detected object sets from an input file." )

  VIAME_REGISTER_PROCESS(
    viame::detected_object_output_process, "detected_object_output",
    "Writes detected object sets to an output file." )

  VIAME_REGISTER_PROCESS(
    viame::read_object_track_process, "read_object_track",
    "Reads object track sets from an input file." )

  VIAME_REGISTER_PROCESS(
    viame::write_object_track_process, "write_object_track",
    "Writes object track sets to an output file." )

  VIAME_REGISTER_PROCESS(
    viame::write_track_descriptor_process, "write_track_descriptor",
