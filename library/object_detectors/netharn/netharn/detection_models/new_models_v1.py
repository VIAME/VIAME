...
Ignore:
    ...
    >>> from viame.object_detectors.netharn.netharn.models.mm_models import _batch_to_mm_inputs
...
import warnings  # NOQA
from viame.object_detectors.netharn.netharn.data import data_containers
...
class LateFusionPyramidBackbone(nn.Module):
    ...
    Ignore:
        ...
        >>> monkeypatch_build_norm_layer()
        >>> from .models.new_models_v1 import *  # NOQA
        >>> from viame.object_detectors.netharn.netharn.models.mm_models import _demo_batch  # NOQA
