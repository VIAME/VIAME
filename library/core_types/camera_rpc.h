...
public:
  ...
  virtual vector_3d back_project(
    const vector_2d& image_pt,
    double elev ) const;
...
public:
  ...
  { return rpc_coeffs_; }
  virtual vector_3d
  world_scale() const { return world_scale_; }
  virtual vector_3d
  world_offset() const { return world_offset_; }
  virtual vector_2d
  ...
  // Setters
  void
  set_rpc_coeffs( rpc_matrix coeffs )
  {
    rpc_coeffs_ = coeffs;
    update_partial_deriv();
  }
