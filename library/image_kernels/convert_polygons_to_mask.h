...
#ifndef VIAME_IMAGE_KERNELS_CONVERT_POLYGONS_TO_MASK_H
#define VIAME_IMAGE_KERNELS_CONVERT_POLYGONS_TO_MASK_H
...
#endif // VIAME_IMAGE_KERNELS_CONVERT_POLYGONS_TO_MASK_H
