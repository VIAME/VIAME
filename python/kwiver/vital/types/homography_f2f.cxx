...
PYBIND11_MODULE( homography_f2f, m )
{
  py::class_< f2f_homography, std::shared_ptr< f2f_homography > >(
    ...
    .def_static(
      "from_floats",
      [](float_mat_t const& mat, kv::frame_id_t const from_id,
         kv::frame_id_t const to_id){
        return f2f_homography( mat, from_id, to_id );
      } )
    .def_static(
      "from_doubles",
      [](double_mat_t const& mat, kv::frame_id_t const from_id,
         kv::frame_id_t const to_id){
        return f2f_homography( mat, from_id, to_id );
      } )
    .def(
      py::init< kv::homography_sptr const&, kv::frame_id_t const,
        kv::frame_id_t const >() )
    ...
    .def(
      "__str__", [](f2f_homography const& self){
