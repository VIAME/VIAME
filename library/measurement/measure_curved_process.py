...
from viame.pipeline import datum, process
from viame.processes.base import ViameProcess

from viame.measurement.curved_measurement import measure_curve, sample_map
...
def mask_polyline(mask, endpoints, count, harmonics, trusted=False):
    ...
    from viame.measurement.curved_measurement import (
...
class MeasureCurvedObjects(ViameProcess):
    ...
    def _configure(self):
        ...
        from viame.measurement.interactive_stereo import DenseStereoRectifier
    ...
    def _refine(self, frame, left_states, image):
        ...
        from viame.types import DetectedObjectSet, ObjectTrackState
    ...
    def _append(self, camera, tid, frame, time_usec, det):
        from viame.types import ObjectTrackState, Track
...
def __sprokit_register__():
    ...
    module_name = 'python:viame.measurement.measure_curved_process'
