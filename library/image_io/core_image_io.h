...
#ifndef VIAME_IMAGE_IO_CORE_IMAGE_IO_H
#define VIAME_IMAGE_IO_CORE_IMAGE_IO_H
...
/// silently dropped.
class VIAME_IMAGE_IO_EXPORT core_image_io
...
#endif // VIAME_IMAGE_IO_CORE_IMAGE_IO_H
