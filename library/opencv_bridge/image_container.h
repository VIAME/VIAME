...
class VIAME_OPENCV_BRIDGE_EXPORT image_container
...
/// The width of the image in pixels
  virtual size_t
  width() const { return data_.cols; }

/// The height of the image in pixels
  virtual size_t
  height() const { return data_.rows; }
...
VIAME_OPENCV_BRIDGE_EXPORT cv::Mat image_container_to_ocv_matrix(
