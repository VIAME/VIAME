...
void write_track_descriptor_set(py::module& m)
{
  ...
  py::module::import("kwiver.vital.types");
    ...
    py::class_<viame::algo::write_track_descriptor_set,
               std::shared_ptr<viame::algo::write_track_descriptor_set>,
               viame::algorithm,
               write_track_descriptor_set_trampoline<> > instance(m,  "WriteTrackDescriptorSet");
    
    instance
    .def(py::init<>())
    .def_static("interface_name", &viame::algo::write_track_descriptor_set::interface_name)
    .def("open", &viame::algo::write_track_descriptor_set::open, py::doc(R"( Open a file of track descriptor sets.
 ...
 \throws viame::path_not_a_file Thrown when the given path does
    ...
    .def("use_stream", &viame::algo::write_track_descriptor_set::use_stream, py::doc(R"( Write track descriptors to an existing stream
 ...
 @param strm output stream to use)"), py::arg("strm"))
    .def("close", &viame::algo::write_track_descriptor_set::close, py::doc(R"( Close track descriptor set file.

 The currently open track descriptor set file is closed. If there is no
 currently open file, then this method does nothing.)"))
    .def("write_set", &viame::algo::write_track_descriptor_set::write_set, py::doc(R"( Write detected object set.
 ...
 \param source_id String source ID)"), py::arg("set"), py::arg("source_id"))
    ;
  register_algorithm< viame::algo::write_track_descriptor_set > (instance);
}
