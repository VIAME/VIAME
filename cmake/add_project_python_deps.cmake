...
set( PYMOTMETRICS_SOURCE_DIR ${VIAME_PACKAGES_DIR}/python-utils/pymotmetrics )
...
if( VIAME_PYTHON_SYMLINK )
  ...
  set( LIBRARY_PIP_INSTALL_CMD
    ${Python_EXECUTABLE} -m pip install --user -e ${PYMOTMETRICS_SOURCE_DIR} )
else()
...
ExternalProject_Add( pymotmetrics
  ...
  PREFIX ${VIAME_BUILD_PREFIX}
  SOURCE_DIR ${PYMOTMETRICS_SOURCE_DIR}
