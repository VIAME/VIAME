...
from viame.object_trackers.siammask.siammask.models.head.rpn import DepthwiseXCorr
from viame.object_trackers.siammask.siammask.core.xcorr import xcorr_depthwise
