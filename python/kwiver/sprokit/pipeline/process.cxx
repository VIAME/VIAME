...
public:
  ...
  ::sprokit::process::conf_info_t _config_info(
    kwiver::vital::config_block_key_t const& key ) override;
};

void declare_input_port_2(
  ::sprokit::process& self,
  ::sprokit::process::port_t const& port,
  ::sprokit::process::port_info_t const& port_info );
...
wrap_edge_datum peek_at_port(
  ::sprokit::process& self,
  ::sprokit::process::port_t const& port, std::size_t idx );
wrap_edge_datum grab_from_port(
  ::sprokit::process& self,
  ::sprokit::process::port_t const& port );
::sprokit::datum grab_datum_from_port(
  ::sprokit::process& self,
  ::sprokit::process::port_t const& port );
::sprokit::datum peek_at_datum_on_port(
  ::sprokit::process& self,
  ::sprokit::process::port_t const& port,
  std::size_t idx );
...
void push_value_to_port(
  ::sprokit::process& self,
  ::sprokit::process::port_t const& port, object const& obj );
void push_datum_to_port(
  ::sprokit::process& self,
  ::sprokit::process::port_t const& port, ::sprokit::datum const& dat );
...
{
  bind_vector< sprokit::process::names_t >(
    m, "ProcessNames",
    module_local(),
  ...
  class_< sprokit::process::conf_info,
    std::shared_ptr< sprokit::process::conf_info > >(
    m, "ConfInfo",
    "Information about a configuration on a process." )
    .def(
    init< kwiver::vital::config_block_value_t,
      kwiver::vital::config_block_description_t, bool >() )
  ...
  class_< sprokit::process::data_info >(
    m, "DataInfo",
  ...
  enum_< sprokit::process::data_check_t >(
    m, "DataCheck",
  ...
  class_< sprokit::process, process_trampoline, sprokit::process_t >(
    m, "PythonProcess",
    "The base class for Python processes." )
    .def(
    init< kwiver::vital::config_block_sptr >(),
    call_guard< pybind11::gil_scoped_release >() )
    .def(
      "configure", &sprokit::process::configure, "Configure the process.",
      call_guard< pybind11::gil_scoped_release >() )
    .def(
      "init", &sprokit::process::init,
      call_guard< pybind11::gil_scoped_release >(),
      "Initializes the process." )
    .def(
      "reset", &sprokit::process::reset,
      call_guard< pybind11::gil_scoped_release >(),
      "Resets the process." )
    .def(
      "step", &sprokit::process::step,
      call_guard< pybind11::gil_scoped_release >(),
      "Steps the process for one iteration." )
    .def(
      "properties", &sprokit::process::properties,
      call_guard< pybind11::gil_scoped_release >(),
      "Returns the properties on the process." )
    .def(
      "connect_input_port", &sprokit::process::connect_input_port,
      call_guard< pybind11::gil_scoped_release >(),
      arg( "port" ), arg( "edge" ),
      "Connects the given edge to the input port." )
    .def(
      "connect_output_port", &sprokit::process::connect_output_port,
      call_guard< pybind11::gil_scoped_release >(),
      arg( "port" ), arg( "edge" ),
      "Connects the given edge to the output port." )
    .def(
      "input_ports", &sprokit::process::input_ports,
      call_guard< pybind11::gil_scoped_release >(),
      "Returns a list of input ports on the process." )
    .def(
      "output_ports", &sprokit::process::output_ports,
      call_guard< pybind11::gil_scoped_release >(),
      "Returns a list of output ports on the process." )
    .def(
      "input_port_info", &sprokit::process::input_port_info,
      call_guard< pybind11::gil_scoped_release >(),
      ( arg( "port" ) ),
      "Returns information about the given input port." )
    .def(
      "output_port_info", &sprokit::process::output_port_info,
      call_guard< pybind11::gil_scoped_release >(),
      ( arg( "port" ) ),
      "Returns information about the given output port." )
    .def(
      "set_input_port_type", &sprokit::process::set_input_port_type,
      call_guard< pybind11::gil_scoped_release >(),
      arg( "port" ), arg( "new_type" ),
      "Sets the type for an input port." )
    .def(
      "set_output_port_type", &sprokit::process::set_output_port_type,
      call_guard< pybind11::gil_scoped_release >(),
      arg( "port" ), arg( "new_type" ),
      "Sets the type for an output port." )
    .def(
      "available_config", &sprokit::process::available_config,
      call_guard< pybind11::gil_scoped_release >(),
      "Returns a list of available configuration keys for the process." )
    .def(
      "available_tunable_config", &sprokit::process::available_tunable_config,
      call_guard< pybind11::gil_scoped_release >(),
      "Returns a list of available tunable configuration keys for the process." )
    .def(
      "config_info", &sprokit::process::config_info,
      call_guard< pybind11::gil_scoped_release >(),
      ( arg( "config" ) ),
      "Returns information about the given configuration key." )

    .def(
      "config_diff", &sprokit::process::config_diff,
      call_guard< pybind11::gil_scoped_release >(),
      "Returns config difference information." )

    .def(
      "name", &sprokit::process::name,
      call_guard< pybind11::gil_scoped_release >(),
      "Returns the name of the process." )
    .def(
      "type", &sprokit::process::type,
      call_guard< pybind11::gil_scoped_release >(),
      "Returns the type of the process." )

    .def_readonly_static(
      "property_no_threads",
      &sprokit::process::property_no_threads )
    .def_readonly_static(
      "property_no_reentrancy",
      &sprokit::process::property_no_reentrancy )
    .def_readonly_static(
      "property_unsync_input",
      &sprokit::process::property_unsync_input )
    .def_readonly_static(
      "property_unsync_output",
      &sprokit::process::property_unsync_output )
    ...
    .def_readonly_static(
      "type_data_dependent",
      &sprokit::process::type_data_dependent )
    .def_readonly_static(
      "type_flow_dependent",
      &sprokit::process::type_flow_dependent )
    .def_readonly_static(
      "flag_output_const",
      &sprokit::process::flag_output_const )
    .def_readonly_static(
      "flag_output_shared",
      &sprokit::process::flag_output_shared )
    .def_readonly_static(
      "flag_input_static",
      &sprokit::process::flag_input_static )
    .def_readonly_static(
      "flag_input_mutable",
      &sprokit::process::flag_input_mutable )
    .def_readonly_static(
      "flag_input_nodep",
      &sprokit::process::flag_input_nodep )
    .def_readonly_static( "flag_required", &sprokit::process::flag_required )
    .def(
      "_base_configure",
      static_cast< void ( sprokit::process::* )() >( &wrap_process::_configure ),
      call_guard< pybind11::gil_scoped_release >(),
      "Configure the base process." )
    .def(
      "_base_init",
      static_cast< void ( sprokit::process::* )() >( &wrap_process::_init ),
      call_guard< pybind11::gil_scoped_release >(),
      "Base class initialization." )
    .def(
      "_base_reset",
      static_cast< void ( sprokit::process::* )() >( &wrap_process::_reset ),
      call_guard< pybind11::gil_scoped_release >(), "Base class reset." )
    .def(
      "_base_flush",
      static_cast< void ( sprokit::process::* )() >( &wrap_process::_flush ),
      call_guard< pybind11::gil_scoped_release >(), "Base class flush." )
    .def(
      "_base_step",
      static_cast< void ( sprokit::process::* )() >( &wrap_process::_step ),
      call_guard< pybind11::gil_scoped_release >(), "Base class step." )
    .def(
      "_base_finalize",
      static_cast< void ( sprokit::process::* )() >( &wrap_process::_finalize ),
      call_guard< pybind11::gil_scoped_release >(), "Base class finalize." )
    .def(
      "_base_reconfigure",
      static_cast< void ( sprokit::process::* )(
        kwiver::vital::config_block_sptr const& ) >( &wrap_process::_reconfigure ),
      call_guard< pybind11::gil_scoped_release >(), arg( "conf" ),
      "Base class reconfigure." )
    .def(
      "_base_properties",
      static_cast< sprokit::process::properties_t ( sprokit::process::* )()
                   const >( &wrap_process::_properties ),
      call_guard< pybind11::gil_scoped_release >(), "Base class properties." )
    .def(
      "_base_input_ports",
      static_cast< sprokit::process::ports_t ( sprokit::process::* )() const >(
    ...
    .def(
      ...
      static_cast< sprokit::process::port_info_t ( sprokit::process::* )(
        sprokit::process::port_t const& ) >( &wrap_process::_input_port_info ),
      call_guard< pybind11::gil_scoped_release >(), arg( "port" ),
      "Base class input port info." )
    .def(
      "_base_output_port_info",
      static_cast< sprokit::process::port_info_t ( sprokit::process::* )(
        sprokit::process::port_t const& ) >( &wrap_process::_output_port_info ),
      call_guard< pybind11::gil_scoped_release >(), arg( "port" ),
      "Base class output port info." )
    .def(
      "_base_set_input_port_type",
      static_cast< bool ( sprokit::process::* )(
        sprokit::process::port_t const&,
        sprokit::process::port_type_t const& ) >( &wrap_process::
    ...
    .def(
      ...
      static_cast< kwiver::vital::config_block_keys_t ( sprokit::process::* )()
                   const >( &wrap_process::_available_config ),
      call_guard< pybind11::gil_scoped_release >(),
      "Base class available configuration information." )
    .def(
      "_base_config_info",
      static_cast< sprokit::process::conf_info_t ( sprokit::process::* )(
        kwiver::vital::config_block_key_t const& ) >( &wrap_process::
                                                      _config_info ),
      call_guard< pybind11::gil_scoped_release >(),
    ...
    .def(
      "remove_input_port",
      static_cast< void ( sprokit::process::* )(
        sprokit::process::port_t const& ) >( &wrap_process::remove_input_port ),
      call_guard< pybind11::gil_scoped_release >(),
      arg( "port" ),
    ...
    .def(
      "remove_output_port",
      static_cast< void ( sprokit::process::* )(
        sprokit::process::port_t const& ) >( &wrap_process::remove_output_port ),
      call_guard< pybind11::gil_scoped_release >(),
      arg( "port" ),
      "Remove an output port from the process." )
    .def(
      "mark_process_as_complete",
      static_cast< void ( sprokit::process::* )() >( &wrap_process::
                                                     mark_process_as_complete ),
      call_guard< pybind11::gil_scoped_release >(),
    ...
    .def(
      "has_input_port_edge",
      static_cast< bool ( sprokit::process::* )(
        sprokit::process::port_t const& ) const >( &wrap_process::
                                                   has_input_port_edge ),
      call_guard< pybind11::gil_scoped_release >(),
      arg( "port" ),
    ...
    .def(
      ...
      static_cast< pybind11::size_t ( sprokit::process::* )(
        sprokit::process::port_t const& ) const >( &wrap_process::
                                                   count_output_port_edges ),
      call_guard< pybind11::gil_scoped_release >(),
      arg( "port" ),
    ...
    .def(
      ...
      static_cast< void ( sprokit::process::* )(
        sprokit::process::port_t const&,
        sprokit::edge_datum_t const& ) const >( &wrap_process::push_to_port ),
      call_guard< pybind11::gil_scoped_release >(),
      arg( "port" ), arg( "datum" ),
    ...
    .def(
      "get_config",
      static_cast< kwiver::vital::config_block_sptr ( sprokit::process::* )()
    ...
    .def(
      ...
      static_cast< void ( sprokit::process::* )(
        sprokit::process::data_check_t ) >( &wrap_process::
                                            set_data_checking_level ),
      call_guard< pybind11::gil_scoped_release >(),
      arg( "check" ),
...
wrap_edge_datum
peek_at_port(
  ::sprokit::process& self, ::sprokit::process::port_t const& port,
  std::size_t idx )
{
  ::sprokit::process* self_ptr = &self;
  ...
  ::sprokit::process::port_t const& port, ::sprokit::datum const& dat )
{
  ...
  return ( ( wrap_process* ) self_ptr )->push_datum_to_port(
    port,
    std::make_shared< ::sprokit::datum >( dat ) );
}
