...
from viame.object_detectors.netharn.netharn.data.channel_spec import ChannelSpec  # TODO: kwcoco.ChannelSpec
...
def _batch_to_mm_inputs(batch, ignore_thresh=0.1):
    ...
    Example:
        ...
        from viame.object_detectors.netharn.netharn.data.collate import padded_collate
