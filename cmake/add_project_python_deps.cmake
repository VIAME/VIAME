...
if( VIAME_ENABLE_PYTORCH AND NOT VIAME_ENABLE_PYTORCH-INTERNAL )
  ...
  if( VIAME_ENABLE_PYTORCH-VIS-INTERNAL )
    ...
    set( TORCHVISION_STR "torchvision==0.8.2+cu110" )
  endif()
  ...
  if( WIN32 AND VIAME_ENABLE_CUDA )
    ...
    elseif( CUDA_VERSION VERSION_EQUAL "11.0" )
      set( ARGS_TORCH "==${PYTORCH_VERSION}+cu110 ${TORCHVISION_STR} -f ${PYTORCH_ARCHIVE}" )
    elseif( CUDA_VERSION VERSION_EQUAL "10.2" )
      set( ARGS_TORCH "==${PYTORCH_VERSION} ${TORCHVISION_STR} -f ${PYTORCH_ARCHIVE}" )
    elseif( CUDA_VERSION VERSION_EQUAL "10.1" )
      set( ARGS_TORCH "==${PYTORCH_VERSION}+cu101 ${TORCHVISION_STR} -f ${PYTORCH_ARCHIVE}" )
    elseif( CUDA_VERSION VERSION_EQUAL "10.0" )
      set( ARGS_TORCH "==${PYTORCH_VERSION}+cu100 ${TORCHVISION_STR} -f ${PYTORCH_ARCHIVE}" )
    elseif( CUDA_VERSION VERSION_EQUAL "9.2" )
      set( ARGS_TORCH "==${PYTORCH_VERSION}+cu92 ${TORCHVISION_STR} -f ${PYTORCH_ARCHIVE}" )
    else()
  ...
  elseif( VIAME_ENABLE_CUDA )
    ...
    set( ARGS_TORCH "==${PYTORCH_VERSION}+cpu ${TORCHVISION_STR} -f ${PYTORCH_ARCHIVE}" )
  endif()
