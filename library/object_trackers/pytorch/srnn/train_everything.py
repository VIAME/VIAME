...
Usage:
    python -m viame.object_trackers.pytorch.srnn.train_everything data_root output_dir [options]

Example:
    python -m viame.object_trackers.pytorch.srnn.train_everything \\
...
def run_mod_raw(args, *more_args, **kwargs):
    ...
    args = ['python', '-m', 'viame.object_trackers.pytorch.srnn.' + args[0], *args[1:]]
