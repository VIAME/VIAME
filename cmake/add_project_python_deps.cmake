...
if( VIAME_ENABLE_PYTORCH-NETHARN AND Python_VERSION VERSION_LESS "3.7" )
  list( APPEND VIAME_PYTHON_BASIC_DEPS "kwimage<=0.9.18" )
endif()
...
if( VIAME_ENABLE_PYTORCH-VIDEO )
  list( APPEND VIAME_PYTHON_ADV_DEPS pyav )
  list( APPEND VIAME_PYTHON_ADV_DEP_CMDS "av --no-binary av" )
endif()
