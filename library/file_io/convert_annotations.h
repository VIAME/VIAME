...
#ifndef VIAME_FILE_IO_CONVERT_ANNOTATIONS_H
#define VIAME_FILE_IO_CONVERT_ANNOTATIONS_H
...
struct VIAME_FILE_IO_EXPORT annotation_conversion_options
{
...
struct VIAME_FILE_IO_EXPORT annotation_conversion_summary
{
  std::string reader;
  std::string writer;
  std::string frame_source;
...
VIAME_FILE_IO_EXPORT std::vector< std::string > const& default_image_extensions();
VIAME_FILE_IO_EXPORT std::vector< std::string > const& default_video_extensions();
...
VIAME_FILE_IO_EXPORT std::string detect_annotation_format( std::string const& path );

/// Reader or writer implementation implied by a file extension such as
/// ".csv" or a path ending in one; empty when unknown
VIAME_FILE_IO_EXPORT std::string format_from_extension( std::string const& path_or_ext );

/// Customary file extension (with the dot) for a format name
VIAME_FILE_IO_EXPORT std::string extension_for_format( std::string const& format );
...
VIAME_FILE_IO_EXPORT std::vector< std::string > list_annotation_files(
...
VIAME_FILE_IO_EXPORT std::string find_frame_source_alongside(
...
/// reason logged.
VIAME_FILE_IO_EXPORT bool convert_annotation_file(
...
#endif // VIAME_FILE_IO_CONVERT_ANNOTATIONS_H
