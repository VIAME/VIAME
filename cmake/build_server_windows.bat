...
SET "PYTHONPATH=%VIAME_BUILD_DIR%\install\%PYTHON_SUBDIR;%VIAME_BUILD_DIR%\install\%PYTHON_SUBDIR%\site-packages"
...
DEL "%VIAME_BUILD_DIR%\VIAME\%PYTHON_SUBDIR%\site-packages\torch\lib\cu*"
