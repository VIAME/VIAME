...
```python
from viame.applets import KwiverApplet, register_applet
...
```python
from viame.applets import register_applet
...
setup(
    ...
    entry_points={
        'viame.python_plugin_registration': [
...
```toml
[project.entry-points."viame.python_plugin_registration"]
my_applet = "my_package.my_applet:register_plugins"
```
