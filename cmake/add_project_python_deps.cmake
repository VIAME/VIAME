...
if( VIAME_ENABLE_PYTORCH AND NOT VIAME_ENABLE_PYTORCH-INTERNAL )
  ...
  if( NOT VIAME_ENABLE_PYTORCH-VIS-INTERNAL )
    if( PYTORCH_VERSION VERSION_EQUAL "1.11.0" )
      set( TORCHVISION_STR "torchvision==0.12.0" )
    elseif( PYTORCH_VERSION VERSION_EQUAL "1.9.1" )
...
if( WIN32 )
  ...
  if( VIAME_ENABLE_PYTHON-INTERNAL )
    set( FLETCH_CPYTHON "build/src/fletch-build/build/src/CPython/Include" )
    set( PYTHON_SOURCE_PATH "${VIAME_BUILD_PREFIX}/${FLETCH_CPYTHON}" )
    set( EXTRA_INCLUDE_DIRS "${PYTHON_SOURCE_PATH};$ENV{INCLUDE}" )
...
set( VIAME_PYTHON_ROOT "${VIAME_INSTALL_PREFIX}" )

if( WIN32 )
  string( REPLACE "/" "//" VIAME_PYTHON_ROOT "${EXTRA_LIBRARY_DIRS}" )
  string( REPLACE "\" "\\" VIAME_PYTHON_ROOT "${EXTRA_LIBRARY_DIRS}" )
endif()

list( APPEND PYTHON_DEP_ENV_VARS "PYTHONPATH=${VIAME_PYTHON_PATH}" )
list( APPEND PYTHON_DEP_ENV_VARS "PYTHONUSERBASE=${VIAME_PYTHON_ROOT}" )
