...
python.exe "%VIAME_INSTALL%\configs\process_video.py" --init -l ingest_list.txt -p pipelines\index_generic.trk.pipe -o database --build-index -install "%VIAME_INSTALL%"
