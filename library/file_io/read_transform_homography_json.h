...
#ifndef VIAME_FILE_IO_READ_TRANSFORM_HOMOGRAPHY_JSON_H
#define VIAME_FILE_IO_READ_TRANSFORM_HOMOGRAPHY_JSON_H
...
#endif // VIAME_FILE_IO_READ_TRANSFORM_HOMOGRAPHY_JSON_H
