...
[VIAME v0.10.2 RHEL/CentOS 7, 64-Bit, GPU Enabled, Python 3.6, Mirror1](https://data.kitware.com/api/v1/item/5de48df0af2e2eed3546a026/download) <br>
[VIAME v0.10.2 RHEL/CentOS 7, 64-Bit, GPU Enabled, Python 3.6, Mirror2](https://drive.google.com/open?id=16UqIRe-VwQKIMgZt9L42Qo8Gt3-lxEHC)
