...
{                                                         \
  template < typename Range > static name##_view< Range > \
  adapt( Range && range )                                 \
...
struct name##_view_adapter_t                                                              \
{                                                                                         \
  template < typename Range > static name##_view< KWIVER_UNPACK_TOKENS arg_names, Range > \
  adapt( Range && range )                                                                 \
  { return { std::forward< Range >( range ) }; }                                          \
};                                                                                        \
                                                                                          \
...
{                                                                        \
  ...
  Functor m_func;                                                        \
                                                                         ...
                                                                         \
template < typename... Args > constexpr name##_view_adapter_t< Args... > \
name( Args... args )                                                     \
{                                                                        \
  return { args... };                                                    \
}                                                                        \
...
public:
  ...
  iterator_t
  begin() const { return detail::begin_helper( m_range ); }
  iterator_t
  end() const { return detail::end_helper( m_range ); }
