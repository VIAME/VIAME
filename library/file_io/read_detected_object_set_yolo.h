...
#ifndef VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_YOLO_H
#define VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_YOLO_H
...
class VIAME_FILE_IO_EXPORT read_detected_object_set_yolo
...
#endif // VIAME_FILE_IO_READ_DETECTED_OBJECT_SET_YOLO_H
