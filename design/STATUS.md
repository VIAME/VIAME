...
- Phase: P5 is complete. VXL and FFmpeg are gone from kwiver, fletch and
  VIAME (P3, P4), video is python on PyAV, and the kwiver submodule is gone:
  `library/`, `python/` and `tools/` are what it was. Phases 1 and 2 are
  still deferred apart from P1-T05, which P5-T05 needed
- Next task: P6-T02, and P0-T06, P1-T01 to P1-T04 and P1-T06 onward,
