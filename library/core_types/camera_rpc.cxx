...
camera_rpc
::camera_rpc()
  : m_logger( viame::get_logger( "viame.camera_rpc" ) )
{}
...
::back_project( const vector_2d& image_pt, double elev ) const
{
  ...
  b[ 1 ] = ( rpc_coeffs()( 3, 0 ) + norm_elev * rpc_coeffs()(
    3,
    3 ) ) * norm_pt[ 1 ] -
...
::jacobian( const vector_3d& pt, matrix_2x2d& J, vector_2d& norm_pt ) const
{
  ...
  J(
    0,
    0 ) = ( ply[ 1 ] * dx_ply[ 0 ] - ply[ 0 ] * dx_ply[ 1 ] ) /
          ( ply[ 1 ] * ply[ 1 ] );
  J(
    0,
    1 ) = ( ply[ 1 ] * dy_ply[ 0 ] - ply[ 0 ] * dy_ply[ 1 ] ) /
          ( ply[ 1 ] * ply[ 1 ] );
  J(
    1,
    0 ) = ( ply[ 3 ] * dx_ply[ 2 ] - ply[ 2 ] * dx_ply[ 3 ] ) /
          ( ply[ 3 ] * ply[ 3 ] );
  J(
    1,
    1 ) = ( ply[ 3 ] * dy_ply[ 2 ] - ply[ 2 ] * dy_ply[ 3 ] ) /
          ( ply[ 3 ] * ply[ 3 ] );
