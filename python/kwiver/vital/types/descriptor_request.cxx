...
PYBIND11_MODULE( descriptor_request, m )
{
  ...
  py::class_< kwiver::vital::descriptor_request,
    ...
    .def_property(
      "id", &kv::descriptor_request::id,
      &kv::descriptor_request::set_id )
    .def_property(
      "spatial_regions", &kv::descriptor_request::spatial_regions,
      &kv::descriptor_request::set_spatial_regions )
    .def_property(
      "image_data", &kv::descriptor_request::image_data,
      &kv::descriptor_request::set_image_data )
    .def_property(
      "data_location", &kv::descriptor_request::data_location,
      &kv::descriptor_request::set_data_location )
    ...
    .def(
      ...
      &kv::descriptor_request::temporal_lower_bound )
    .def(
      "temporal_upper_bound",
      &kv::descriptor_request::temporal_upper_bound )
