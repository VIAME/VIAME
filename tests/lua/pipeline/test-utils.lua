...
function test_import()
    if not pcall(require, "vistk.pipeline.utils") then
        log("Error: Failed to import the utils module")
    end
end


function test_create()
    require("vistk.pipeline.utils")

    vistk.pipeline.thread_name()
end


function test_name_thread()
    require("vistk.pipeline.utils")

    vistk.pipeline.name_thread("a_name")
end
...
function main(testname)
    ...
    elseif testname == 'create' then
        test_create()
    elseif testname == 'name_thread' then
        test_name_thread()
    else
