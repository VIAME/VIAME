...
#ifndef VIAME_FILE_IO_WRITE_DETECTED_OBJECT_SET_DIVE_H
#define VIAME_FILE_IO_WRITE_DETECTED_OBJECT_SET_DIVE_H
...
// -----------------------------------------------------------------------------
class VIAME_FILE_IO_EXPORT write_detected_object_set_dive
...
private:
  ...
  int m_frame_number;
  viame::track_id_t m_next_id;
  std::vector< viame::track_sptr > m_tracks;
};

} // end namespace

#endif // VIAME_FILE_IO_WRITE_DETECTED_OBJECT_SET_DIVE_H
