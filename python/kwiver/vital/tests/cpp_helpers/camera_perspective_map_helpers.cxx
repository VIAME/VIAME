...
{
  m.def(
    "call_size", []( const kv::camera_map_of_< kv::camera_perspective >& self ){
      return self.size();
    } );

  m.def(
    "call_cameras", []( const kv::camera_perspective_map& self ){
      return self.cameras();
    } );

  m.def(
    "call_get_frame_ids",
    []( const kv::camera_map_of_< kv::camera_perspective >& self ){
