...
#ifndef VIAME_PIPELINE_FRAMEWORK_FILTER_FRAME_PROCESS_H
#define VIAME_PIPELINE_FRAMEWORK_FILTER_FRAME_PROCESS_H
...
#endif // VIAME_PIPELINE_FRAMEWORK_FILTER_FRAME_PROCESS_H
