...
#ifndef VIAME_IMAGE_KERNELS_HOMOGRAPHY_OVERLAP_H
#define VIAME_IMAGE_KERNELS_HOMOGRAPHY_OVERLAP_H

#include <image_kernels/polygon.h>
...
#endif // VIAME_IMAGE_KERNELS_HOMOGRAPHY_OVERLAP_H
