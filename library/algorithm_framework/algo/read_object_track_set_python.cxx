...
void read_object_track_set(py::module& m)
{
  ...
  py::module::import("kwiver.vital.types");
    ...
    py::class_<viame::algo::read_object_track_set,
               std::shared_ptr<viame::algo::read_object_track_set>,
               viame::algorithm,
               read_object_track_set_trampoline<> > instance(m,  "ReadObjectTrackSet");
    
    instance
    .def(py::init<>())
    .def_static("interface_name", &viame::algo::read_object_track_set::interface_name)
    .def("open", &viame::algo::read_object_track_set::open, py::doc(R"( Open a file of object track sets.
 ...
 \throws viame::file_not_found_exception)"), py::arg("filename"))
    .def("use_stream", &viame::algo::read_object_track_set::use_stream, py::doc(R"( Read object tracks from an existing stream
 ...
 @param strm input stream to use)"), py::arg("strm"))
    .def("close", &viame::algo::read_object_track_set::close, py::doc(R"( Close object track set file.

 The currently open object track set file is closed. If there is no
 currently open file, then this method does nothing.)"))
    .def("read_set", &viame::algo::read_object_track_set::read_set, py::doc(R"( Read next object track set
 ...
 @return \b true if object tracks are returned, \b false if end of file.)"), py::arg("set"))
    .def("at_eof", &viame::algo::read_object_track_set::at_eof, py::doc(R"( Determine if input file is at end of file.

 This method reports the end of file status for a file open for reading.

 @return \b true if file is at end.)"))
    .def("stream", &viame::algo::read_object_track_set::stream)
    .def("new_stream", &viame::algo::read_object_track_set::new_stream)
    ;
  register_algorithm< viame::algo::read_object_track_set > (instance);
}
