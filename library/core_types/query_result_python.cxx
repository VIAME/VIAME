...
#include <viame/core_types/query_result.h>
...
void
query_result_set_descriptors(
  kv::query_result& self,
...
PYBIND11_MODULE( query_result, m )
{
  py::class_< kwiver::vital::query_result,
    ...
    .def_property(
      "query_id", &kv::query_result::query_id,
      &kv::query_result::set_query_id )
    .def_property(
      "stream_id", &kv::query_result::stream_id,
      &kv::query_result::set_stream_id )
    .def_property(
      "instance_id", &kv::query_result::instance_id,
      &kv::query_result::set_instance_id )
    .def_property(
    ...
    .def_property(
      "tracks", &kv::query_result::tracks,
      &kv::query_result::set_tracks )
    .def_property(
      "descriptors", &query_result_get_descriptors,
      &query_result_set_descriptors )
    .def_property(
      "image_data", &kv::query_result::image_data,
      &kv::query_result::set_image_data )
