...
void detected_object_set_output(py::module& m)
{
  ...
  py::module::import("kwiver.vital.types");
    ...
    instance
    .def(py::init<>())
    .def_property("filename", &kwiver::vital::algo::detected_object_set_output::get_filename, &kwiver::vital::algo::detected_object_set_output::set_filename)
    .def_static("interface_name", &kwiver::vital::algo::detected_object_set_output::interface_name)
    .def("open", &kwiver::vital::algo::detected_object_set_output::open, py::doc(R"( Open a file of detection sets.
 ...
 \throws kwiver::vital::path_not_a_file Thrown when the given path does
    ...
    .def("use_stream", &kwiver::vital::algo::detected_object_set_output::use_stream, py::doc(R"( Write detections to an existing stream
 ...
 @param strm output stream to use)"), py::arg("strm"))
    .def("close", &kwiver::vital::algo::detected_object_set_output::close, py::doc(R"( Close detection set file.

 The currently open detection set file is closed. If there is no
 currently open file, then this method does nothing.)"))
    .def("write_set", &kwiver::vital::algo::detected_object_set_output::write_set, py::doc(R"( Write detected object set.
 ...
 \param image_path File path to image associated with the detections.)"), py::arg("set"), py::arg("image_path"))
    .def("complete", &kwiver::vital::algo::detected_object_set_output::complete, py::doc(R"( Perform end-of-stream actions.

 This method writes any necessary final data to the currently open file.)"))
    .def("get_filename", &kwiver::vital::algo::detected_object_set_output::get_filename, py::doc(R"(@{
 Filename property
 @note  Required for accessing it as a python property)"))
    .def("set_filename", &kwiver::vital::algo::detected_object_set_output::set_filename, py::arg("filename"))
    ;
  register_algorithm< kwiver::vital::algo::detected_object_set_output > (instance);
}
