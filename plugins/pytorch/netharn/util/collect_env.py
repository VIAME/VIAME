...
def get_conda_packages(run_lambda):
    # If we are not in cond do nothing
...
def get_pip_packages(run_lambda):
    ...
    # MODIFICATION: just run with whatever python we are using
    ...
    out = run_and_read_all(run_lambda, pip + ' list --format=freeze | ' + grep_cmd)
    return 'pip', out
...
if __name__ == '__main__':
    """
    CommandLine:
        python ~/code/netharn/netharn/util/collect_env.py --profile
    """
    main()
